...
void main(List<String> arguments) {
  ...
  */
  ...
  /*
    ...
    // in int you cannot change type
    // int myInt = 10;
    // myInt = 3.14159; // No allowed in dart.
    // print(myInt);

    // num assign type automatically and type can be change to double-int
    // num aNumber = 10;
    // aNumber = 3.14;
    // aNumber = 'y'; //Not Allowed in dart.

    // dynamic assign type automatically and type can be changed to anything
  ...
  */
  ...
  /*
    ...
    // var assign type automatically and type cannot be changed !!!
    // var aNumber = 10;
    // aNumber = 15; // OK
    // aNumber = 3.14159; // No, no, no.

    // Constants will be constant from compilation
    // const aConstantNum = 50;
    // aConstantNum = 80; // Will Give a Error

    // final will be constant which decides at runtime
    // final aFinal = DateTime.now().hour;
    // aFinal = DateTime.now().hour; // Will Give an Error

    // Using meaningful names
    // var firstName = "hardik";
    // print(firstName) ;
  */

...
// Collections : Lists , Sets and Maps
  ...
  // Lists
  // var desserts = ["IceCream","RasGulla","Penda","Chocolate"];
  // print(desserts);
  // print(desserts[1]);
/*
  var greetings = [];  // Not Type Safe
  // greetings.[1] = "Hi";
  // greetings[1] = "Hi";
  // greetings.add("HI","Hello","Welcome");
  greetings.add(90);
  greetings.add("Hello");
...
/*
  ...
  // final days = <String>[];
  var days = <String>[];
  days.addAll(["Sun","Mon","Tue","Wed","Thu","Fri","Sat"]);
  // days[0] = "sun";
  // days = ["0","1","2","3"]; // Error with final
  // days.removeRange(1, 6);  // Allowed with final
  print(days);
  print(days[0]);
  days.remove("Sun");
  days.add("Sun");
  print(days);
  print(days.indexOf("Mon"));
*/
